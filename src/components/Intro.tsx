...
import profilePic from "../assets/picture-1.jpg";
        ...
        <div className="w-full lg:w-1/2 lg:p-8">
          <div className="flex justify-center">
            <motion.img
              ...
              src={profilePic || "https://via.placeholder.com/300x400?text=Profile+Image"}
              alt="Dr. Ricardo Virgill Smart"
